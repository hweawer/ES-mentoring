...
public class AuthorizationServerConfig extends AuthorizationServerConfigurerAdapter {
    ...
    public AuthorizationServerConfig(AuthenticationManager authenticationManager, AuthorizationProperties authorizationProperties){
    ...
    public void configure(ClientDetailsServiceConfigurer configurer) throws Exception {
        configurer
                ...
                .secret(authorizationProperties.clientSecret)
