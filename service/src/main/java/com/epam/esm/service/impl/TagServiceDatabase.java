...
public class TagServiceDatabase implements TagService {
    ...
    public TagDTO findByName(String name) throws EntityNotFoundException {
        Specification specification = DatabaseSpecifications.findTagByName(name);
    ...
    private void validateDTO(TagDTO tagDTO) throws ValidationException {
        ...
        if(!violations.isEmpty()){
            ...
            throw new ValidationException("Tag isn't valid:\n" + StringUtils.join(violationMessages, '\n'));
        }
    }
}
